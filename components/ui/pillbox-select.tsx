...
export const PillboxSelect: React.FC<SelectPillsProps> = ({
  data,
  defaultValue = [],
  value,
  onValueChange,
          ...
          {filteredItems.map((item, index) => (
            ...
            >
              <input
                ...
                name="pill-selection"
                value={item.name}
                className="sr-only peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
